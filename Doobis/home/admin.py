...
from home.models import CustomUser,Address
...
class CustomUserAdmin(UserAdmin):
    ...
    search_fields = ('username', 'account_type', 'email', 'phone_number' ,'country','state','city')
    ...
    fieldsets = (
        ...
        ('Additional Information', {'fields': ( 'status', 'verified', 'terms_and_conditions',
                                               'profile_picture', 'cover_picture',  'address','postcode',  'location','country','state','city' )})
    )
